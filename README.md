...
/src ├── sparse_core.sv # The math engine (4 Parallel PEs) ├── sparse_pe.sv # Processing Element logic ├── sparse_pkg.sv # SystemVerilog data types & structs ├── axi_sparse_wrapper.sv # AXI4-Lite Bus Interface /sim ├── tb_axi_sparse_wrapper.sv # Master Testbench (CPU Emulation) ├── weights_nz.mem # Compressed Weights (Generated by Python) ├── indices.mem # Sparsity Indices (Generated by Python) /scripts ├── sparsity_generator.py # Python script for pruning & packing
